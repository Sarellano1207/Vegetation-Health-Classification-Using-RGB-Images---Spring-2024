...
import numpy as np
input_image_path = Path("data/processed/Val/subtiles/Tile48/0_0/landsat_rgb.nc")
ndvi_image_path = Path("data/processed/Val/subtiles/Tile48/0_0/landsat_ndvi.nc")
...
#compute accurracy between two numpy arrays:
